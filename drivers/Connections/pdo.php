...
use ADOdb\drivers\PDOStatement as ADOPDOStatement;
use \ADOConnection;
use \Exception;
...
class pdo extends ADOConnection {
	...
	function _connect($argDSN, $argUsername, $argPassword, $argDatabasename, $persist=false)
	{
		...
		try {
			$this->_connectionID = new NativePDO($argDSN, $argUsername, $argPassword);
		} catch (Exception $e) {
		...
		if ($this->_connectionID) {
			switch(ADODB_ASSOC_CASE){
				case ADODB_ASSOC_CASE_LOWER:
					$m = NativePDO::CASE_LOWER;
					break;
				case ADODB_ASSOC_CASE_UPPER:
					$m = NativePDO::CASE_UPPER;
					break;
				default:
				case ADODB_ASSOC_CASE_NATIVE:
					$m = NativePDO::CASE_NATURAL;
					break;
			}

			//$this->_connectionID->setAttribute(NativePDO::ATTR_ERRMODE,NativePDO::ERRMODE_SILENT );
			$this->_connectionID->setAttribute(NativePDO::ATTR_CASE,$m);
			...
			//$this->_connectionID->setAttribute(NativePDO::ATTR_AUTOCOMMIT,true);
			switch($this->dsnType) {
				case 'mssql':
				case 'mysql':
				case 'oci':
	...
	function BeginTrans()
	{
		...
		$this->_connectionID->setAttribute(NativePDO::ATTR_AUTOCOMMIT,false);
